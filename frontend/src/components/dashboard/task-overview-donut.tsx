...
export function TaskOverviewDonut() {
  return (
    <div className="glass-card flex flex-col rounded-2xl p-5 sm:p-6">
      <h3 className="font-(family-name:--font-zeyada) text-[26px] leading-none font-normal text-(--flow-ink)">Task Overview</h3>
      <div className="mt-6 flex min-h-[220px] flex-1 flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-(--flow-ink)/12 py-10 text-center">
        ...
        <p className="text-[21px] font-(family-name:--font-zeyada) leading-none font-normal text-(--flow-ink)/55">No tasks yet</p>
        <p className="max-w-[200px] text-[18px] font-(family-name:--font-zeyada) leading-snug font-normal text-(--flow-ink)/40">
